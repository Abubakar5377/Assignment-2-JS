document.getElementById("Concatenate").onclick=function () {
    ...
    let num2 = "80"
    let sum = num1 + num2 ;
    document.getElementById("Statement").innerHTML='"10" + "80"'
 ...
 document.getElementById("ifnested").onclick=function () {
     ...
     if(userName==="Abubakar"){
         ...
         document.getElementById("output").innerHTML="Wrong userNAme <br> Correct user name is Abubakar"
     }
 }
 ...
 document.getElementById("login").onclick = function () {
     ...
     if(Username ==="abubakar"){
         if(Password==="402344"){
             ...
             document.getElementById("output").innerHTML="incorrect password or username <br>abubakar use as username or 402344 as password"
         }
     }
     else{
